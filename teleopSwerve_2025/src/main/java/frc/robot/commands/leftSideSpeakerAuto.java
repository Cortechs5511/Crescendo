...
public class leftSideSpeakerAuto extends Command{
    ...
    public leftSideSpeakerAuto(SwerveSubsystem driveSubsystem, Wrist wristSubsystem, Intake intakeSubsystem, Feeder feederSubsystem) {
